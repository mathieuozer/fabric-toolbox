...
export function AppRouter() {
  ...
  // Check URL for dashboard route - allow direct access without login
  useEffect(() => {
  ...
  // Sync subscription with backend when user logs in (optional enhancement)
  useEffect(() => {
  ...
  // Show dashboard if user navigated there (no login required for Free tier)
  if (showDashboard) {
    return <App />;
  }
